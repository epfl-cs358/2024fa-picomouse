...
void loop() 
{
  ...
  Serial.printf("left = %hu , mid_left = %hu , middle = %.0f , mid_right = %hu , right = %hu ", 
                  side_distances[0], side_distances[1], mid_distance, side_distances[2], side_distances[3]);
  Serial.println();
  delay(250);
}